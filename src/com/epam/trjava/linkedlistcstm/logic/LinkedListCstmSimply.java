...
public class LinkedListCstmSimply {
	...
	/**
	 * Method adds new node into LinkedList
	 * Mission:
	 * step 1: create Entry with node with value and next fields; 
	 * step 2: find the last node; 
	 * step 3: set next field of last node on created node.
	 * @param value - Object to add in LinkedList
	 */
	...
	/**
	 * Method removes the node by the value from LinkedList
	 * Mission:
	 ...
	 * @param value - Object to remove from LinkedList
	 */
	public boolean remove(Object value) {
		...
		while (null != current) {
			...
			if (current.element.equals(value)) {
				...
				//step 3b: Removable node is in the middle or in the end of LinkedList
				if (previous != null) {
					...
					//step 2 or 3a: One element in Linked List (previous = null) or removable node is first
					head = head.next;
